...
PARAM$experimento <- "ExpeirmentoLoco_HT4510"
...
hs <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0, upper = 0.9),
  makeNumericParam("feature_fraction", lower = 0.1, upper = 0.9),
  makeIntegerParam("min_data_in_leaf", lower = 1L, upper = 8000L),
  makeIntegerParam("num_leaves", lower = 8L, upper = 512L),
  makeIntegerParam("envios", lower = 1000L, upper = 20000L),    
  makeNumericParam("min_gain_to_split", lower = 0.0, upper = 30), 
