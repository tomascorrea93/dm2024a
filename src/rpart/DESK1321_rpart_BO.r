...
setwd("C:/Users/tomas/OneDrive/Documentos/ITBA/Data Mining")
...
dir.create("./exp/DKHT3220/", showWarnings = FALSE)

# Establezco el Working Directory DEL EXPERIMENTO
setwd("./exp/DKHT3220/")


archivo_log <- "DKHT322.txt"
archivo_log_mejor <- "DKHT322_mejor.txt"
archivo_BO <- "DKHT322.RDATA"
