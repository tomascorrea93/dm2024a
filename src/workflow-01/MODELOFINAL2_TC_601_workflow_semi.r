...
envg$EXPENV$exp_dir <- "~/buckets/b1/expwMODELOFINAL2TC/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flowMODELOFINAL2TC/"
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train <- c(202107, 202106, 202105, 202104, 202103, 202102, 202101,
                               202012, 202011, 202010, 202009, 202008, 202003, 
...
wf_semillerio9 <- function( pnombrewf )
{
 ...
 # CN_canaritos_asesinos_base(ratio=0.1, desvio=0)
